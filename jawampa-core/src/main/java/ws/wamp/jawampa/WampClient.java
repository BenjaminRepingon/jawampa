...
public class WampClient
{
	...
	public static class DisconnectedState implements State
	{
		...
		/**
		 * @return An optional reason that describes why the client got
	...
	public static class ConnectedState implements State
	{
		...
		/**
		 * @return The sessionId that was assigned to the client by the router
		 */
		...
		/**
		 * @return The details of the welcome message that was sent from the router
		 * to the client
		 */
		...
		/**
		 * @return The roles that the router implements
		 */
	...
	/**
	 * @return The URI of the router to which this client is connected
	 */
	...
	/**
	 * @return The name of the realm on the router
	 */
	public String realm()
	{
	...
	/**
	 * @return An Observable that allows to monitor the connection status of the Session.
	 */
	 ...
	 * @param <T>        The type of the return Observable
	 ...
	 * @param <T>        The type of the EventDetails
	 *
	...
	/**
	 * @return An observable that will be completed with a single value once the client terminates.<br>
	...
	/**
	 * @return A future that will be completed once the client terminates.<br>
